...
def ADOF(input_tensor):
    ...
    # Use atan2 to get full gradient direction (range: [-pi, pi])
...
class Detector(nn.Module):
    def __init__(self, backbone='adof', num_features = 'auto', num_classes=1, pretrained=False, freeze_exclude=None):
